...
public class TrafficAnalyticsService : ITrafficAnalyticsService
{
    ...
    {
        return await _repository.GetTrafficIncidentsAsync(from, to, area, severity, null, null, null, null, null, cancellationToken);
    }
    ...
    {
        return await _repository.GetTrafficFlowsAsync(from, to, area, null, null, null, null, null, cancellationToken);
    }
    ...
    {
        var incidents = await _repository.GetTrafficIncidentsAsync(from, to, null, null, null, null, null, null, null, cancellationToken);
        return incidents
            .GroupBy(i => i.Type)
    ...
    {
        var flows = await _repository.GetTrafficFlowsAsync(from, to, null, null, null, null, null, null, cancellationToken);
        return flows
            .GroupBy(f => f.Area)
